        ...
        try {
            ...
            switch (c.methodIdentifier) {
                ...
                case 60:
                    ...
                    oos.writeObject(result);
                case 61:
                    UserRequest ur12 = (UserRequest)c.requestObject;
                    ArrayList<User> users_with_req = ur12.selectUsersWithReq();
                    result = new Communication(users_with_req);
                    oos.writeObject(result); 
                case 62:
                    UserRequest ur13 = (UserRequest)c.requestObject;
                    ArrayList<UserRequest> ur_unprocessed = ur13.selectUnprocessed();
                    result = new Communication(ur_unprocessed);
                    oos.writeObject(result); 
            }
